...
export default function SettingsModal({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-4 bg-black/85 backdrop-blur-xl animate-fade-in">
      <div
        className="w-full max-w-4xl bg-[#121214] border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col h-[92vh] max-h-[850px] text-white"
        onClick={(e) => e.stopPropagation()}
      >
        {/* ── Modal Top Header ────────────────────────────────────────── */}
        <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-white/5 bg-[#18181a]">
        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
          ...
          <div className="md:hidden flex flex-col flex-1 min-h-0">
            ...
            {/* Content Container */}
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5 bg-[#0e0e0e] no-scrollbar">
